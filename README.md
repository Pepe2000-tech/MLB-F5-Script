# MLB Betting Hub — V7.1 Alpha

V7.1 agrega **momios de referencia automáticos** a la arquitectura V7.
...
- Si la API ofrece una línea distinta a la recomendada por el modelo, V7.1 recalcula la probabilidad sobre la línea de mercado antes de evaluar el precio.
...
4. V7.1 calcula primero el modelo y después consulta precios sólo para candidatos preseleccionados.
...
La API utiliza créditos por mercados/regiones consultados. V7.1 agrupa mercados por juego y limita el pool consultado para evitar gasto innecesario. La pantalla Express muestra los créditos restantes cuando la API los devuelve.
